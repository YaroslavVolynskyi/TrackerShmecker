...
object SampleData {
    ...
    private val RAW: Map<String, Map<Int, ActivityType>> = mapOf(
        ...
        // ── 2026 ──
        "2026-1" to mapOf(
            3 to GYM, 4 to GYM, 6 to GYM, 8 to GYM, 10 to GYM, 13 to GYM,
            14 to GYM, 16 to GYM, 18 to GYM, 20 to GYM, 21 to GYM, 22 to GYM,
            23 to GYM, 26 to GYM, 30 to GYM,
            11 to TENNIS, 17 to TENNIS, 19 to TENNIS, 25 to TENNIS,
            31 to TENNIS,
            1 to DAY_OFF, 2 to DAY_OFF, 5 to DAY_OFF, 7 to DAY_OFF,
            9 to DAY_OFF, 12 to DAY_OFF, 15 to DAY_OFF, 24 to DAY_OFF,
            27 to DAY_OFF, 28 to DAY_OFF, 29 to DAY_OFF,
        ),
        "2026-2" to mapOf(
            3 to GYM, 4 to GYM, 5 to GYM, 6 to GYM, 10 to GYM, 11 to GYM,
            14 to GYM, 15 to GYM, 18 to GYM, 20 to GYM, 21 to GYM, 23 to GYM,
            25 to GYM, 28 to GYM,
            7 to TENNIS, 16 to TENNIS, 22 to TENNIS,
            1 to DAY_OFF, 2 to DAY_OFF, 8 to DAY_OFF, 9 to DAY_OFF,
            12 to DAY_OFF, 13 to DAY_OFF, 17 to DAY_OFF, 19 to DAY_OFF,
            24 to DAY_OFF, 26 to DAY_OFF, 27 to DAY_OFF,
        ),
        "2026-3" to mapOf(
    ...
    private val NOTES: Map<LocalDate, String> = mapOf(
        ...
        LocalDate.of(2026, 1, 6) to "81.3 kg",
